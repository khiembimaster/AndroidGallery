...
import android21ktpm3.group07.androidgallery.Utils.SlideShowCustom.adapters.ViewPagerAdapter;
import android21ktpm3.group07.androidgallery.Utils.SlideShowCustom.animations.*;
    ...
    public void setSlideAnimation(AnimationTypes animationType) {
        switch (animationType) {
            ...
            case GATE:
                ...
                break;
            case FADE:
                viewPager.setPageTransformer(true, new FadedTransition());
                break;
            default:
    ...
    private void playAudio(String audio) {
        ...
        audioThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (audio.contains("R.raw")){

                    String packageName = context.getPackageName();

                    int audioResourceId = getResources().getIdentifier(audio, "raw", packageName);

                    if (audioResourceId == 0) {
                        Log.e("Play Audio", "Resource not found");
                        return;
                    }

                    // Set data source cho MediaPlayer từ tài nguyên raw
                    mediaPlayer.create(context, audioResourceId);
